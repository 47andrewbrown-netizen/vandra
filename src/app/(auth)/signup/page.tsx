    ...
    return (
      <div className="text-center">
        ...
        <p className="text-sm text-[var(--color-stone-500)] mb-8">
          Click the link in the email to create your account. The link expires in 24 hours.
        </p>
        <button
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-[var(--color-stone-600)]">
          Start getting flight deals delivered to your phone
        </p>
      </div>
          ...
          {hasEmail && (
            <>
              ...
              <p className="mt-4 text-center text-sm text-[var(--color-stone-500)]">
                We&apos;ll email you a link to sign up—no password needed.
              </p>
            </>
          )}
        </>
      ...
      <p className="mt-6 text-center text-xs text-[var(--color-stone-500)]">
